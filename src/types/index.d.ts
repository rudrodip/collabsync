...
import { FloatingCardProps } from "@/components/guide/floating-cards/floating-card"
...
export type StepConfig = {
  ...
  title: string,
  desc: string,
  floating_card: (FloatingCardProps) => JSX.Element
}
...
export type { SiteConfig, ZenodoQueryParams, ZenodoData, Hit }